    ...
    <div className="container">
      <div className="modal">
        <div className="modal__header">
          <span className="modal__title">New Book Create</span>
        </div>
        ...
        <div className="modal__footer">
          <button style={{ letterSpacing: "1.5px", fontWeight: "800", marginLeft: "-9px" }} className='button is-ghost' onClick={handleSaveBook}>
            Create Book
          </button>
        </div>
      </div>
